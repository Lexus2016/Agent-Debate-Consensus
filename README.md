...
> **v2.5.2** — Rewrote every line of welcome-screen copy in EN/UA/RU to sound like a human wrote it. No more "multi-agent platform" / "unified gateway" / abstract bullet lists — concrete examples, plain words, and a voice you'd actually use in conversation.
